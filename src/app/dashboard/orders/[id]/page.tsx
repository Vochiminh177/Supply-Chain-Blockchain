      ...
      {blocks.length > 0 && (
        <div className="mt-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center">
              <div
                className={`w-3 h-3 rounded-full mr-2 ${blockchainVerification.valid ? "bg-green-500" : "bg-red-500"}`}
              ></div>
              <span className="text-sm">
                {blockchainVerification.valid ? "Blockchain hợp lệ" : "Blockchain không hợp lệ"}
              </span>
            </div>
          </div>
